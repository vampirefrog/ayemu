...
{                                                                       \
	(x) = ((struct ay_player *) context)->memory[(address) & 0xffff];   \
}
...
{                                                                       \
	unsigned char   *memory;                                            \
	                                                                    \
	memory = ((struct ay_player *) context)->memory;                    \
...
{                                                                       \
	((struct ay_player *) context)->memory[(address) & 0xffff] = (x);   \
}
...
{                                                                       \
	(x) = ay_player_in((struct ay_player *)context, (state->registers.byte[Z80_B] << 8) | port, elapsed_cycles); \
}

#define Z80_OUTPUT_BYTE(port, x)                                        \
{                                                                       \
	ay_player_out((struct ay_player *)context, (state->registers.byte[Z80_B] << 8) | port, (x), elapsed_cycles); \
}
